...
public final class Constants {
  ...
  public static final ImmutableList<String> fbAuthResponseTypes =
      ImmutableList.of(CODE, TOKEN, COOKIE);
  public static final ImmutableList<String> passwordlessAuthResponseTypes =
      ImmutableList.of(CODE, TOKEN, COOKIE);
  public static final ImmutableList<String> registerResponseTypes =
      ImmutableList.of(CODE, TOKEN, COOKIE);
  public static final ImmutableList<String> loginResponseTypes =
      ImmutableList.of(CODE, TOKEN, COOKIE);
