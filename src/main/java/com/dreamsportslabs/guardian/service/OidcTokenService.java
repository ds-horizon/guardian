...
public class OidcTokenService {
                    ...
                    .flatMap(
                        oidcScopes ->
                            userService.getOidcUser(
                                getUserFilters(oidcCodeModel, oidcScopes), headers, tenantId))
                    .flatMap(
                        userResponse -> {
  ...
  private Map<String, String> getUserFilters(OidcCodeModel oidcCodeModel, List<String> oidcScopes) {
    List<String> scopes = new ArrayList<>(oidcScopes);
    scopes.retainAll(oidcCodeModel.getConsentedScopes());
    Map<String, String> filters = new HashMap<>();
    filters.put(SCOPE, String.join(" ", scopes));
