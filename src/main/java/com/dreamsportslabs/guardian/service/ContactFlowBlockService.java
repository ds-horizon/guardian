...
public class ContactFlowBlockService {
    ...
    public Single<ResponseBuilder> blockContactFlows(V1BlockContactFlowRequestDto dto, String tenantId) {
    ...
    public Single<Boolean> isApiBlocked(String tenantId, String contact, String apiPath) {
        ...
        List<Single<Boolean>> flowChecks = BlockFlow.getAllFlowNames().stream()
                .map(flowName -> {
        ...
        return Single.merge(flowChecks)
