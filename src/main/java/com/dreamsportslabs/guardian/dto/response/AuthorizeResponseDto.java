...
public class AuthorizeResponseDto {
  ...
  public Response toResponse() {
    if (loginPageUri == null) {
      throw INTERNAL_SERVER_ERROR.getJsonCustomException("loginPageUri is required but was null");
    }
    ...
    try {
      ...
      throw INTERNAL_SERVER_ERROR.getJsonCustomException(
          "Failed to create URI builder from loginPageUri: " + e.getMessage());
    }
