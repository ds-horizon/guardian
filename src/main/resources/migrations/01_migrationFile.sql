...
(
    ...
    same_site   VARCHAR(256) NOT NULL,
    cookie_name VARCHAR(256) NOT NULL,
    created_at  TIMESTAMP    NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at  TIMESTAMP    NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,

    CONSTRAINT fk_tenant_cookie_config FOREIGN KEY (tenant_id)
        REFERENCES tenant (id) ON DELETE CASCADE,
...
(
    ...
    cookie_name  CHAR(20)                    NOT NULL,
    cookie_value CHAR(32)  COLLATE ascii_bin NOT NULL,
    cookie_exp   BIGINT UNSIGNED NOT NULL,
    same_site    CHAR(6)                     NOT NULL,
    domain       VARCHAR(256)                NOT NULL,
    path         VARCHAR(256)                NOT NULL,
    source       VARCHAR(50),
    ...
    PRIMARY KEY (id),
    KEY          `idx_cookie` (`tenant_id`, `cookie_value`, `is_active`, `cookie_exp`, `user_id`),
    KEY          `idx_cookie_userId` (`tenant_id`, `user_id`)
