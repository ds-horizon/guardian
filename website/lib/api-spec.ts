    ...
    "/v1/passwordless/init": {
      post: {
        ...
        requestBody: {
          content: {
            "application/json": {
              schema: { $ref: "#/components/schemas/V1PasswordlessInitRequestBody" },
            },
          },
          required: true,
        },
        responses: {
          "200": {
            ...
            content: {
              "application/json": {
                schema: {
                  oneOf: [{ $ref: "#/components/schemas/State" }],
                },
              },
            },
          },
    ...
    "/v1/passwordless/complete": {
      post: {
        ...
        requestBody: {
          content: {
            "application/json": {
              schema: { $ref: "#/components/schemas/V1PasswordlessCompleteRequestBody" },
            },
          },
          required: true,
        },
        responses: {
          "200": {
            ...
            content: {
              "application/json": {
                schema: {
                  oneOf: [{ $ref: "#/components/schemas/Tokens" }],
                },
              },
            },
          },
    ...
    "/v1/signup": {
      post: {
        ...
        requestBody: {
          content: {
            "application/json": {
              schema: { $ref: "#/components/schemas/V1SignupRequestBody" },
            },
          },
          required: true,
        },
    ...
    "/v1/signin": {
      post: {
        ...
        requestBody: {
          content: {
            "application/json": {
              schema: { $ref: "#/components/schemas/V1SigninRequestBody" },
            },
          },
        },
        responses: {
    ...
    "/v1/auth/fb": {
      post: {
        ...
        requestBody: {
          content: {
            "application/json": {
              schema: { $ref: "#/components/schemas/V1AuthFbRequestBody" },
            },
          },
          required: true,
        },
    ...
    "/v1/auth/google": {
      post: {
        ...
        requestBody: {
          content: {
            "application/json": {
              schema: { $ref: "#/components/schemas/V1AuthGoogleRequestBody" },
            },
          },
          required: true,
        },
    ...
    "/v1/refreshToken": {
      post: {
        ...
        requestBody: {
          content: {
            "application/json": {
              schema: { $ref: "#/components/schemas/V1RefreshTokenRequestBody" },
            },
          },
          required: true,
        },
        responses: {
          "200": {
            ...
            content: {
              "application/json": {
                schema: {
                  oneOf: [{ $ref: "#/components/schemas/RefreshToken" }],
                },
              },
            },
          },
    ...
    "/v1/logout": {
      post: {
        ...
        requestBody: {
          content: {
            "application/json": {
              schema: { $ref: "#/components/schemas/V1LogoutRequestBody" },
            },
          },
          required: true,
        },
